...
const weekMessages = [
  ...
  [
    2,
    "Edgar Loayza",
    integrants[2].profileImage,
    "Buen día gentita, por fin tengo el grato deber de saludar al grupo. Espero que sea un día lleno alegrías y momentos memorables. Recordemos que hoy juega la verde 💚 \n Disfruten, renieguen, sufran y lloren sea de alegría o tristeza, pero sientan...porque sentir es lo que nos hace humanos. Un abrazo 🫂",
    "Tuesday",
  ],
